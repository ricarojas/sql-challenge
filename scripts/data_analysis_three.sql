With DepartmentInfo AS (SELECT departments.dept_no, departments.dept_name, dept_manager.emp_no
	FROM public.departments, public.dept_manager
...
WHERE employees.emp_no = DepartmentInfo.emp_no;